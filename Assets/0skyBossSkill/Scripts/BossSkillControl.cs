...
public class BossSkillControl : MonoBehaviour
{
    ...
    [Header("Skill Settings - Laser / 激光")]
    [Tooltip("激光移动速度")]
    ...
    [Header("Skill Settings - Scatter Bullets / 散射子弹")]
    [Tooltip("散射子弹波数")]
    ...
    [Header("Skill Settings - Meteor Fall /陨石坠落")]
    [Tooltip("陨石波数")]
